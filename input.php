      ...
      <div class="max-w-sm mx-auto my-10  rounded shadow-md p-5 bg-white">
        <fieldset>
          ...
          <label class="block mb-2 texr-gray-900"><select name="type" id="type">
              <option value="">属性:ボケorツッコミ</option>
            </select></label>
          <p>趣味 / 好きなこと3選</p>
          <label class="block mb-2 texr-gray-900"><input type="text" name="favo1" required placeholder="ラーメン" class="outline-none border-b-2 p-1 w-5/6"></label>
          <label class="block mb-2 texr-gray-900"><input type="text" name="favo2" required placeholder="カレーライス" class="outline-none border-b-2 p-1 w-5/6"></label>
          <label class="block mb-2 texr-gray-900"><input type="text" name="favo3" required placeholder="山登り" class="outline-none border-b-2 p-1 w-5/6"></label>
          <p>ひとことメッセージ</p>
          ...
          <!--  tesutotuikas -->
          <p>ヘッダー画像（後からでもOK)</p>
          <p class="cms-thumb-header"><img class="shadow-lg w-32 h-32 object-cover rounded mx-auto" src="https://placehold.jp/c9c9c9/ffffff/600×600.png?text=%E3%83%80%E3%83%9F%E3%83%BC%E7%94%BB%E5%83%8F" width="200"></p>
          <input type="file" name="upload_header_image"><br>
